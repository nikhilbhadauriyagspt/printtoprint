...
export default function ShippingPolicy() {
  return (
    ...
    >
      <p className="lead">
        This Shipping & Delivery Policy is part of our Terms and Conditions ("Terms") and should be therefore read alongside our main Terms: <Link to="/terms-and-conditions">https://printiply.shop/terms-and-conditions</Link>.
      </p>
      <p>
      ...
      <p>
        If you have questions about returns, please review our Return Policy: <Link to="/return-policy">https://printiply.shop/return-policy</Link>.
      </p>
