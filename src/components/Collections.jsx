      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black text-blue-600 uppercase tracking-[0.4em]">Core Pillars</span>
          </div>
        ...
        <Link to="/shop" className="group flex items-center gap-3 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-950 transition-all border-b border-slate-100 pb-2">
          ...
          <div className="absolute inset-0 p-10 md:p-16 flex flex-col justify-end z-10">
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-900">Computing</span>
              </div>
              ...
              <Link to="/shop?category=laptop-computers" className="inline-flex items-center gap-4 h-14 px-8 bg-slate-950 text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-blue-600 hover:scale-105 transition-all shadow-xl shadow-black/10">
          ...
          <div className="absolute inset-0 p-10 md:p-16 flex flex-col justify-end z-10">
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-900">Precision</span>
              </div>
              ...
              <Link to="/shop?category=printers" className="inline-flex items-center gap-4 h-14 px-8 bg-slate-950 text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-purple-600 hover:scale-105 transition-all shadow-xl shadow-black/10">
