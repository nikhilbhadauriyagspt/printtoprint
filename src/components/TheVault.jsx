      ...
      <div className="max-w-[1920px] mx-auto">
        ...
        <div className="flex items-end justify-between mb-16 gap-6">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black text-blue-600 uppercase tracking-[0.4em]">Curated Essentials</span>
            </div>
              ...
              <CarouselItem key={p.id} className="pl-6 basis-[85%] sm:basis-1/2 md:basis-1/3 lg:basis-1/4 xl:basis-1/6">
                ...
                >
                  ...
                  <div className="mt-5 px-1 space-y-1">
                    <p className="text-[8px] font-black text-blue-600 uppercase tracking-widest">{p.brand_name || 'Electronics'}</p>
                    <h4 className="text-[11px] font-black text-slate-900 uppercase tracking-tight truncate group-hover:text-blue-600 transition-colors">{p.name}</h4>
        ...
        <div className="mt-16 flex justify-center">
           <Link to="/shop" className="group flex items-center gap-4 px-10 py-4 bg-slate-50 hover:bg-slate-950 hover:text-white rounded-full transition-all duration-500 border border-slate-100">
              <span className="text-[10px] font-black uppercase tracking-[0.3em]">Access Full Collection</span>
