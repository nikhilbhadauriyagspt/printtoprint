      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black text-blue-600 uppercase tracking-[0.4em]">Latest Drop</span>
          </div>
            ...
            >
              ...
              <div className="mt-5 px-1">
                <Link to={`/product/${p.slug}`}>
                  <h3 className="text-[11px] font-black text-slate-950 uppercase tracking-tight line-clamp-1 group-hover:text-blue-600 transition-colors mb-1">{p.name}</h3>
                </Link>
