      ...
      <div className="flex items-end justify-between mb-16">
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em]">Most Wanted</span>
          </div>
              ...
              >
                <div className="relative aspect-square rounded-[2rem] bg-slate-50 border border-slate-100 overflow-hidden flex items-center justify-center p-8 transition-all duration-700 hover:bg-white hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] hover:border-blue-500/20">
                  ...
                  <div className="absolute top-5 left-5 z-10">
                    <span className="px-2.5 py-1 bg-white border border-slate-100 rounded-lg text-[8px] font-black uppercase tracking-widest text-slate-400">
                      {p.brand_name || 'Top'}
                    </span>
                  </div>
                ...
                <div className="mt-5 px-1">
                  <Link to={`/product/${p.slug}`}>
                    <h3 className="font-black text-slate-900 text-sm mb-1 uppercase tracking-tight line-clamp-1 group-hover:text-blue-600 transition-colors">{p.name}</h3>
                  </Link>
